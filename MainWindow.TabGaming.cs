...
namespace GMTPC.Tool
{
    public partial class MainWindow
    {
        ...
        private async Task InstallGhostOfTsushimaAsync()
        {
            ...
            {
                string gmtFolder = GetGMTPCFolder();
                string part01Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part01.exe");
                string part02Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part02.rar");
                string part03Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part03.rar");
                string part04Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part04.rar");
                string part05Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part05.rar");
                string part06Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part06.rar");
                string part07Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part07.rar");
                string part08Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part08.rar");
                string part09Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part09.rar");
                string part10Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part10.rar");
                string part11Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part11.rar");
                string part12Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part12.rar");
                string part13Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part13.rar");
                string part14Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part14.rar");
                string part15Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part15.rar");
                string part16Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part16.rar");
                string part17Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part17.rar");
                string part18Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part18.rar");
                string part19Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part19.rar");
                string part20Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part20.rar");
                string part21Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part21.rar");
                string part22Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part22.rar");
                string part23Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part23.rar");
                string part24Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part24.rar");
                string part25Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part25.rar");
                string part26Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part26.rar");
                string part27Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part27.rar");
                string part28Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part28.rar");
                string part29Path = Path.Combine(gmtFolder, "Ghost.of.Tsushima_LinkNeverDie.Com.part29.rar");
                ...
                // Delete all parts after installation
                if (File.Exists(part01Path)) File.Delete(part01Path);
                if (File.Exists(part02Path)) File.Delete(part02Path);
                if (File.Exists(part03Path)) File.Delete(part03Path);
                if (File.Exists(part04Path)) File.Delete(part04Path);
                if (File.Exists(part05Path)) File.Delete(part05Path);
                if (File.Exists(part06Path)) File.Delete(part06Path);
                if (File.Exists(part07Path)) File.Delete(part07Path);
                if (File.Exists(part08Path)) File.Delete(part08Path);
                if (File.Exists(part09Path)) File.Delete(part09Path);
                if (File.Exists(part10Path)) File.Delete(part10Path);
                if (File.Exists(part11Path)) File.Delete(part11Path);
                if (File.Exists(part12Path)) File.Delete(part12Path);
                if (File.Exists(part13Path)) File.Delete(part13Path);
                if (File.Exists(part14Path)) File.Delete(part14Path);
                if (File.Exists(part15Path)) File.Delete(part15Path);
                if (File.Exists(part16Path)) File.Delete(part16Path);
                if (File.Exists(part17Path)) File.Delete(part17Path);
                if (File.Exists(part18Path)) File.Delete(part18Path);
                if (File.Exists(part19Path)) File.Delete(part19Path);
                if (File.Exists(part20Path)) File.Delete(part20Path);
                if (File.Exists(part21Path)) File.Delete(part21Path);
                if (File.Exists(part22Path)) File.Delete(part22Path);
                if (File.Exists(part23Path)) File.Delete(part23Path);
                if (File.Exists(part24Path)) File.Delete(part24Path);
                if (File.Exists(part25Path)) File.Delete(part25Path);
                if (File.Exists(part26Path)) File.Delete(part26Path);
                if (File.Exists(part27Path)) File.Delete(part27Path);
                if (File.Exists(part28Path)) File.Delete(part28Path);
                if (File.Exists(part29Path)) File.Delete(part29Path);
            }
            catch (Exception ex)
            {
